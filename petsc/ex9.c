...
Options include:\n\
  -feasible     use feasible initial guess\n\
  -fd           use coloring to compute Jacobian by finite differences\n";
...
This example was contributed by Ed Bueler \url{http://bueler.githu.io}.
F*/
...
int main(int argc,char **argv)
{
  ...
  /* variational inequality-specific settings */
...
/*  FormBounds() for call-back: tell SNES that we want u >= psi */
