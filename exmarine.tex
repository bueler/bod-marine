...
\subsection*{Acknowledgements and erratum}  Thanks to Heinz Blatter and Helgi Bj\"ornsson for tracking down a copy of \citebod.  Spellings of \bod include ``Bodvardsson'' and ``Bodvarsson'' in the literature.  \cite{BLKCB} incorrectly identify the constant accumulation SIA solution as ``Bodvarsson (1955)--\cite{Vialov},'' but it is attributable only to Vialov.
